...
```{r plot_influence, fig.width=10, fig.height=6}
...
```{r caching_demo, fig.width=10, fig.height=6}
...
```{r implementation_comparison, fig.width=10, fig.height=8}
